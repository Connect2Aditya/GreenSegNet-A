...
class GreenSegNetEncoder(nn.Module):
    r"""The Encoder for GreenSegNet
    Args:
        ...
        block (strorType[Greenblock], optional): the block to use for depth scaling. Defaults to 'Greenblock'.
        ...
        expansion (int, optional): the expansion ratio of the Greenblock block. Defaults to 4.
    ...
    def __init__(self,
                 ...
                 block: str or Type[Greenblock] = 'Greenblock',
