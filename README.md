...
Sample data is available at the: "[Google Drive Link](https://drive.google.com/drive/folders/1Xzd_GhUHHGtsWS9cuQmyu9gs5_0lWTOV?usp=sharing)". Sample data is a portion of the "[DALES](https://arxiv.org/abs/2004.11985)" dataset. There are just two classes in the data, `vegetation (label: 0)` and `non-vegetation (label: 1)`.
